...
const Hero = () => {
    return (
        <section
            id="home"
            className="relative w-full overflow-hidden bg-black text-white pt-48 pb-20 sm:pt-52 md:h-screen md:min-h-[800px] md:flex md:items-center md:justify-center md:pt-0 md:pb-0"
        >
            {/* Background Elements */}
